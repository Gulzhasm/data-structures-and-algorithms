...
public class Graph {
    ...
    public void bfsForSSSPP(GraphNode node){ //time O[E] E-edges, space O(V) V - vertices
        Queue<GraphNode> queue = new LinkedList<>();
        queue.add(node);
        ...
        while(!queue.isEmpty()){
            GraphNode currentNode = queue.remove();
            currentNode.isVisited = true;
            System.out.print( "Printing shortest path for node " + currentNode.name + ": ");
